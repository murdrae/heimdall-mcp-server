...
from cognitive_memory.core.memory import (
    ...
    BridgeMemory, MemoryConnection, ConsolidationResult, SystemStats
)
...
class TestActivationResult:
    ...
    def test_get_all_memories(self, sample_memories):
        ...
        result = ActivationResult(
            core_memories=sample_memories[:2],
            peripheral_memories=sample_memories[2:]
        )
    ...
    def test_get_by_level(self, sample_memories):
        ...
        result = ActivationResult(
            ...
            peripheral_memories=sample_memories[3:]
        )
...
class TestSystemStats:
    ...
    def test_stats_to_dict(self):
        ...
        stats = SystemStats(
            total_memories=50,
            average_activation_time_ms=125.5
        )
