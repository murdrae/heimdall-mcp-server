...
class TestContextualExtractor:
    ...
    def test_dimension_names(self) -> None:
        ...
        names = self.extractor.get_dimension_names()
        expected = [
            "work_context", "technical_context", "creative_context",
            "analytical_context", "collaborative_context", "individual_context"
        ]
        assert names == expected
...
class TestCognitiveDimensionExtractor:
    ...
    def test_complete_extraction(self) -> None:
        ...
        text = "I'm frustrated working on this urgent project and need help from my team"
        ...
        for category, tensor in dims.items():
